  ...
  <section className="relative isolate overflow-hidden rounded-[2rem] bg-slate-950 px-6 py-10 text-white shadow-xl shadow-slate-950/10 sm:px-10 sm:py-14 lg:px-14">
    ...
    <div className="relative max-w-3xl">
      ...
      <div className="mt-7 flex flex-wrap items-center gap-4">
        <CreatePlaceButton />
        <span className="inline-flex items-center gap-2 text-sm text-slate-300"><ShieldCheck className="size-4 text-emerald-300" /> {t("host.control")}</span>
      </div>
    </div>
  </section>
  );

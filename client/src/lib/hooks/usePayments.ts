...
export interface PaymentsContextValue {
  ...
  createPayment: (input: { bookingId?: string; experienceBookingId?: string; serviceRequestId?: string; currency?: string }) => Promise<{ success: boolean; clientSecret?: string; message?: string }>

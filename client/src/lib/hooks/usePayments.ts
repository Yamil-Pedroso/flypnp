...
export interface PaymentsContextValue {
  ...
  createPayment: (input: { bookingId?: string; experienceBookingId?: string; serviceRequestId?: string; currency?: string; useGiftBalance?: boolean }) => Promise<{ success: boolean; clientSecret?: string; message?: string }>
